...
export default async function ViewAtividades(props: Atividades) {
                        ...
                        return (
                            <tbody className="grid grid-cols-1 ml-4 w-full">
                                <tr className="bg-white-Normalhover">
                                    <td className="pl-10">{props.nome}</td>
                                    <td className="pl-20"> {dayjs(props.quando).format('D[/]M[/]YY [as] HH[:]mm')} </td>
                                    <td className="pl-10">{props.descricao}</td>
