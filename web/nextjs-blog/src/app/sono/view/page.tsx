        ...
        <div className="grid justify-items-center">
            ...
            <div className="bg-green-Dark h-96 w-[38rem] min-h-full">
                <table>
                    ...
                    {sonos.map((sono: { avaliacao: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | PromiseLikeOfReactNode | null | undefined; inicio: string | number | Date | dayjs.Dayjs | null | undefined; fim: string | number | Date | dayjs.Dayjs | null | undefined; id: any; }  ) => {
                        return (
                            <tbody className="grid grid-cols-1 ml-4 w-full">
                                <tr className="bg-white-Normalhover">
                                    <td className="pl-10">{sono.avaliacao}</td>
                                    <td className="pl-32"> {dayjs(sono.inicio).format('D[/]M[/]YY [as] HH[:]mm')} </td>
                                    <td className="pl-10"> {dayjs(sono.fim).format('D[/]M[/]YY [as] HH[:]mm')} </td>
